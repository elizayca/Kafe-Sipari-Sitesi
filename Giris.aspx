<%@ Page Title="" Language="C#" MasterPageFile="~/anasayfa2.master" AutoEventWireup="true" CodeFile="Giris.aspx.cs" Inherits="Giris" %>
      ...
      <table>
          <tr>
              ...
              <td class="auto-style50">
                  <asp:TextBox ID="txtKullaniciAd" runat="server" CssClass="txt_yan" Width="390px" Height="35px" ValidationGroup="giris"></asp:TextBox>
                  <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="!" ControlToValidate="txtKullaniciAd" ValidationGroup="giris"></asp:RequiredFieldValidator>
                  </td>
          </tr>
          <tr>
              ...
              <td class="auto-style37">
                 ...
                 <asp:TextBox ID="txtKullaniciSifre" runat="server" CssClass="txt_yan" Width="390px" Height="35px" ValidationGroup="giris" TextMode="Password"></asp:TextBox>
          ...
          <tr>
              ...
              <td>
                  <asp:TextBox ID="txtKullanicisifreee" runat="server" CssClass="auto-style51" Width="390px" Height="35px" ValidationGroup="giris" TextMode="Password"></asp:TextBox>
             <asp:CompareValidator ID="CompareValidator1" runat="server" ErrorMessage="!" ControlToCompare="txtKullaniciSifre" ControlToValidate="txtKullaniciSifreee" ValidationGroup="giris"></asp:CompareValidator>
                  </td>
          </tr>
      </table>
